...
const Checkout = () => {
  ...
  return (
    <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 mt-10 mb-10">
        ...
        <div className="">
          ...
          <div className="mt-6 border-t border-b py-2">
            <div className="flex items-center justify-between">
              ...
              <p className="font-semibold text-gray-900">${total(cart).toFixed(2)}</p>
            </div>
            <div className="flex items-center justify-between">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <p className="text-2xl font-semibold text-gray-900">${(total(cart) + 10).toFixed(2)}</p>
          </div>
        </div>
